...
int nAnonymizeB3CoinAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\B3Coin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\B3Coin
    // Mac: ~/Library/Application Support/B3Coin
    // Unix: ~/.B3Coin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "B3Coin";
#else
    fs::path pathRet;
