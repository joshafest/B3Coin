...
public:
    CMainParams() {
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1471866666, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1471866666;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact(); 
        genesis.nNonce   = 3369538560;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("00afdc3cf88bbf419d2f09ab261ba4e0cc60b4e2c44321aef56f05d3c0ca8459"));
        assert(genesis.hashMerkleRoot == uint256("4354540cbaeea8d353de639e67558962a9e105f689a08a35f330028158a47f0b"));
        ...
        vSeeds.push_back(CDNSSeedData("First",  "192.168.43.6"));
