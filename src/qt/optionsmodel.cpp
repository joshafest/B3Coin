...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeB3CoinAmount"))
        settings.setValue("nAnonymizeB3CoinAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeB3CoinAmount = settings.value("nAnonymizeB3CoinAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeB3CoinAmount"))
        SoftSetArg("-anonymizeB3Coinamount", settings.value("nAnonymizeB3CoinAmount").toString().toStdString());
}
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeB3CoinAmount:
            return QVariant(nAnonymizeB3CoinAmount);
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeB3CoinAmount:
            nAnonymizeB3CoinAmount = value.toInt();
            settings.setValue("nAnonymizeB3CoinAmount", nAnonymizeB3CoinAmount);
            emit AnonymizeB3CoinAmountChanged(nAnonymizeB3CoinAmount);
            break;
        default:
            break;
        }
